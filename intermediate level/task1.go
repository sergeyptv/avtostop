...
// именно 3 горутина, потому что программа максимально простая и в го выполняется первой последняя созданная горутина
// (LIFO). В прочих ситуациях - выбор будет случайным.
//
